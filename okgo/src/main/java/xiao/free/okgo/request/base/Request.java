...
import xiao.free.okgo.adapter.AdapterParam;
import xiao.free.okgo.adapter.CacheCall;
import xiao.free.okgo.adapter.Call;
import xiao.free.okgo.adapter.CallAdapter;
import xiao.free.okgo.cache.CacheEntity;
import xiao.free.okgo.cache.CacheMode;
import xiao.free.okgo.cache.policy.CachePolicy;
import xiao.free.okgo.callback.Callback;
import xiao.free.okgo.convert.Converter;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    protected CacheMode cacheMode;//设置请求的缓模式
    ...
    protected transient Converter<T> converter;//返回结果数据转换器
    protected transient CachePolicy<T> cachePolicy;//设置自定义请求缓存策略
